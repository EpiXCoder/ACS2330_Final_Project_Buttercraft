...
function OrderForm() {
  ...
  return (
    <div className="OrderForm" role="form">
      <h3 className="cake-order-title">Request a quote</h3>
      <form className="cake-order-form">
        <label htmlFor="tier">Tier:</label>
        <select name="tier" id="tier" value={formState.tier} onChange={handleChange}>
        ...
        <select name="flavor" id="flavor" value={formState.flavor} onChange={handleChange}>
    ...
    <div className="OFR-C">
      <div className="OFR-C2">
        <input
          ...
          onChange={handleChange}
        />
        <label htmlFor="pickup" className="OF-radiolabel">
          Pick Up
        </label>
      </div>
      <div className="OFR-C2">
        <input
          ...
          onChange={handleChange}
        />
        <label htmlFor="delivery" className="OF-radiolabel">
          Delivery
        </label>
      </div>
    </div>
